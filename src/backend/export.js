  ...
  try {
    ...
    const result = await client.query(`
      SELECT 
        ...
        q.answer2,
        r.knowledge_rating1,
        r.correctness_rating1,
        r.empathy_rating1,
        r.knowledge_rating2,
        r.correctness_rating2,
        r.empathy_rating2,
        r.comments
      FROM 
        users u
    ...
    const csvWriter = createObjectCsvWriter({
      ...
      header: [
        ...
        { id: 'correctness_rating1', title: 'Correctness Rating (Answer 1)' },
        { id: 'empathy_rating1', title: 'Empathy Rating (Answer 1)' },
        { id: 'knowledge_rating2', title: 'Knowledge Rating (Answer 2)' },
        { id: 'correctness_rating2', title: 'Correctness Rating (Answer 2)' },
